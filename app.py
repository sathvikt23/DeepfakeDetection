...
def streamlit_menu():
    selected = option_menu(
        menu_title=None,
        options=["Home", "DeepFake Detection", "Text Verification", "Take a Photo", "About"],
        icons=["house", "camera", "check-circle", "photo", "info-circle"],
        menu_icon="cast",
        default_index=0,
...
def main():
    ...
    pages = {
        ...
        "Text Verification": text_verification_page,
...
def text_verification_page():
    import text_verification
    text_verification.run()
